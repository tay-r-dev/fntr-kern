...
Cap angle and Cap distance are rows under Caps.

## Target

1. Square shows Project angle and Distance as compact scrub fields.

## Done when

- [ ] Each value writes the same field as before.
