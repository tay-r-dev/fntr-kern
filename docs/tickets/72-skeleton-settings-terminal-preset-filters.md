# 72: Skeleton settings: terminal preset filters

**Status:** done

**Blocked by:** 71 (Skeleton settings: terminal presets table), 15 (Pair table: Unicode types dropdown)
...
1. Type, Master and Case dropdowns and Current in the table header.
