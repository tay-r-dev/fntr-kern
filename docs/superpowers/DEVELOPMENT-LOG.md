...
- **Shift+Z turns a corner or terminal handle by hand**, at half the cursor's
  sweep. It was Alt+Z first, and moved the same day on the designer's call. **Manual matrix owed** (rail R-G):
