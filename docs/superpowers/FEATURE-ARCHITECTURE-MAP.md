...
| `fontra-core/src/bulb-geometry.js` | — | **NEW** — endpoint-rib bulb geometry. Reads attachment points and tangents only; no wall trimming. `test-bulb-geometry.js` checks wall preservation and parameter sweeps. |
