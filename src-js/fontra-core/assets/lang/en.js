...
export const strings = {
  ...
  "action.build-glyph": "Build %0 Glyph",
  "action.build-glyph.plural": "Build %0 Glyphs",
  "action.close-contour": "Close %0 Contour",
  "action.close-contour.plural": "Close %0 Contours",
  "action.convert-contour-to-skeleton": "Convert Contour to Skeleton...",
  "action.convert-contour-to-skeleton.plural": "Convert Contours to Skeleton...",
  "action.convert-contour-to-skeleton.title": "Convert to skeleton",
  "action.convert-contour-to-skeleton.width": "Stroke width",
  "action.convert-contour-to-skeleton.width-profile": "Width",
  "action.convert-contour-to-skeleton.width-profile.custom": "Custom",
  "action.convert-contour-to-skeleton.mode": "Sides",
  "action.convert-contour-to-skeleton.mode.double": "Both sides",
  "action.convert-contour-to-skeleton.mode.left": "Left side only",
  "action.convert-contour-to-skeleton.mode.right": "Right side only",
  "action.convert-contour-to-skeleton.refused.quadratic":
    "A quadratic contour cannot become a skeleton. Convert its curves to cubic first.",
  "action.convert-contour-to-skeleton.refused.empty":
    "This contour has no on-curve points, so there is nothing to stroke.",
  "action.copy": "Copy",
  ...
  "action.simplify-contour.nothing-to-simplify":
    "These contours are already as simple as they can be without changing their shape.",
  ...
  "composition.button.undo-compose-all": "Undo compose all (%0 glyphs)",
  ...
  "composition.undo.compose-all": "undo compose all",
  ...
  "edit-tools-skeleton.undo.delete-insertion-point": "Delete Insertion Point",
  ...
  "edit-tools-skeleton.undo.insert-insertion-point": "Add Insertion Point",
  ...
  "editor.marker-tool": "Marker Tool",
  ...
  "shortcuts.realtime.insertion-point": "Insertion point (hold)",
  ...
  "sidebar.designspace-navigation.measurements": "Measurements",
  "sidebar.designspace-navigation.measurements.distance": "Distance",
  "sidebar.designspace-navigation.measurements.tension": "Tension",
  "sidebar.designspace-navigation.measurements.angle": "Angle",
  "sidebar.designspace-navigation.tunni": "Tunni",
  "sidebar.designspace-navigation.tunni.basic": "Basic",
  "sidebar.designspace-navigation.tunni.skeleton": "Skeleton",
  ...
  "sidebar.designspace-navigation.skeleton": "Skeleton",
  "sidebar.designspace-navigation.skeleton.show-generated": "Show generated geometry",
  ...
  "sidebar.selection-info": "Metrics",
  ...
  "sidebar.selection-info.go-to-kerning-view": "Go to kerning view",
  "sidebar.selection-info.kern-group-l-r": "Kern group L/R",
  "sidebar.selection-info.kerning-heading": "Kerning",
  ...
  "sidebar.letterspacer.bulk.this-font": "This font",
  ...
  "sidebar.markers.free": "free",
  "sidebar.markers.groups": "Groups",
  "sidebar.markers.no-groups": "No groups",
  "sidebar.markers.on-skeleton": "skeleton",
  "sidebar.markers.rays": "Rays",
  ...
  "sidebar.markers.column.nodes": "Nodes",
  "sidebar.markers.column.value": "Value",
  "sidebar.markers.column.count": "Markers",
  "sidebar.markers.column.name": "Name",
  "sidebar.markers.erase-section": "Erase every marker in this section",
  "sidebar.markers.erase-section-armed":
    "Press again to erase every marker in this section.",
  "sidebar.markers.hide-section": "Hide this section's markers",
  "sidebar.markers.show-section": "Show this section's markers",
  "sidebar.markers.hide-group": "Hide group",
  "sidebar.markers.show-group": "Show group",
  "sidebar.markers.group": "Group",
  "sidebar.markers.hide-marker": "Hide marker",
  "sidebar.markers.new-group": "New group",
  "sidebar.markers.no-group": "No group",
  "sidebar.markers.no-glyph": "No glyph selected",
  "sidebar.markers.show-marker": "Show marker",
  "sidebar.markers.none": "No markers in this glyph",
  "sidebar.markers.target": "Target",
  "sidebar.markers.title": "Markers",
  "sidebar.skeleton-parameters.title": "Skeleton",
  ...
  "sidebar.skeleton-settings.width-presets": "Width presets",
  "sidebar.skeleton-settings.terminal-presets": "Terminal presets",
  "sidebar.skeleton-settings.column.type": "Type",
  "sidebar.skeleton-settings.column.name": "Name",
  "sidebar.skeleton-settings.column.width": "Width",
  "sidebar.skeleton-settings.column.side": "Side",
  "sidebar.skeleton-settings.side.both": "Both",
  "sidebar.skeleton-settings.side.left": "Left",
  ...
  "sidebar.skeleton-parameters.cap-style.round": "Rounded",
  "sidebar.skeleton-parameters.cap-style.drop": "Ball",
  ...
  "sidebar.skeleton-parameters.serif-force.group": "Force %0 to %1 side",
  "sidebar.skeleton-parameters.serif-force.all": "Force all to %0 side",
  "sidebar.skeleton-parameters.serif-field.wingLength": "Width",
  "sidebar.skeleton-parameters.serif-field.tipThickness": "Height",
  "sidebar.skeleton-parameters.serif-field.wingSlope": "Slope",
  "sidebar.skeleton-parameters.serif-field.tipCutAngle": "Tip cut",
  "sidebar.skeleton-parameters.serif-field.reach": "Reach",
  "sidebar.skeleton-parameters.serif-field.tension": "Tension",
  "sidebar.skeleton-parameters.serif-field.concavity": "Concavity",
  "sidebar.skeleton-parameters.serif-field.easeDistance": "Distance",
  "sidebar.skeleton-parameters.serif-field.easeCurvature": "Curvature",
  ...
  "sidebar.skeleton-parameters.serif-group-angle": "Angle",
  "sidebar.skeleton-parameters.serif-axis-tilt": "Tilt",
  "sidebar.skeleton-parameters.serif-underside-cup": "Cup",
  "sidebar.skeleton-parameters.serif-group-cup": "Cup",
  "sidebar.skeleton-parameters.serif-group-wing": "Wing",
  "sidebar.skeleton-parameters.serif-group-bracket": "Bracket",
  "sidebar.skeleton-parameters.serif-group-easing": "Easing",
  ...
  "sidebar.skeleton-parameters.cap-radius": "Radius",
  "sidebar.skeleton-parameters.cap-tension": "Roundness",
  "sidebar.skeleton-parameters.cap-angle": "Project angle",
  "sidebar.skeleton-parameters.cap-distance": "Distance",
  ...
  "sidebar.skeleton-parameters.force-angle": "Force angle",
  "sidebar.skeleton-parameters.force-angle.free": "Free",
  "sidebar.skeleton-parameters.force-angle.vertical": "Vertical",
  "sidebar.skeleton-parameters.force-angle.horizontal": "Horizontal",
  "sidebar.skeleton-parameters.rib-angle-lock-mode": "Forced rib keeps",
  "sidebar.skeleton-parameters.rib-angle-lock-mode.stroke": "Keep the stem width",
  "sidebar.skeleton-parameters.rib-angle-lock-mode.rib": "Keep the footprint",
  ...
  "sidebar.skeleton-parameters.width-preset.reset": "Reset to default",
  ...
  "sidebar.skeleton-parameters.group.projection": "Projection",
  "sidebar.skeleton-parameters.projection.both": "Center",
  "sidebar.skeleton-parameters.projection.left": "Left",
  "sidebar.skeleton-parameters.projection.right": "Right",
  "sidebar.skeleton-parameters.projection.options": "Projection options",
  ...
  "sidebar.skeleton-parameters.total-width": "Total",
  "sidebar.skeleton-parameters.left-width": "Left",
  "sidebar.skeleton-parameters.right-width": "Right",
  ...
  "sidebar.skeleton-parameters.sides.keep-form": "Keep shape",
  "sidebar.skeleton-parameters.sides.keep-edits": "Preserve changes",
  "sidebar.skeleton-parameters.contour-default-width": "Default width",
  "sidebar.skeleton-parameters.caps": "Terminal",
  "sidebar.skeleton-parameters.corner-rounding": "Corner rounding",
  "sidebar.skeleton-parameters.corner-distance-left": "Distance L",
  ...
  "sidebar.skeleton-parameters.undo.set-single-sided": "set sides",
  ...
  "sidebar.skeleton-parameters.undo.set-rib-angle-lock-mode": "set forced rib mode",
  "sidebar.skeleton-parameters.undo.set-preset-bond": "set preset bond",
  "sidebar.skeleton-parameters.undo.refresh-preset": "refresh from preset",
  "sidebar.skeleton-parameters.undo.reset-preset": "reset to default",
  ...
  "sidebar.skeleton-parameters.undo.reset-slide": "reset on-curve slide",
